...
# Randomly generates a name and age for the patient.
...
# Initializes a new conversation with a given scenario.

def start_new_conversation(scenario_id):
    conversation_id = len(conversations) + 1
    name, age = generate_personal_info()
    scenario = health_scenarios[scenario_id]
    initial_prompt = f"Pretend you are a patient who is {age} years old with {scenario['condition']}. Your initial symptom is '{scenario['initial_symptom']}' I will be a doctor asking you questions so this would be a conversation. If I say BYE, you will give me an evaluation of how I performed with you as the patient. Ready?"
